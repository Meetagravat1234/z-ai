...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const categoryMap: Record<string, { label: string; title: string; description: string }> = {
    fresher: {
      ...
      description:
        'Verified fresher jobs in India. Software, data, marketing, sales roles at TCS, Infosys, Wipro, Flipkart, Swiggy, and 100+ companies. Apply free — no signup required.',
    },
    internship: {
      label: 'Internship',
