  ...
  return (
    <div className="space-y-6 pb-8">
      <header>
        ...
        <h1 className="text-3xl font-extrabold tracking-tight">AI Cover Letter</h1>
        <p className="text-muted-foreground mt-2 max-w-2xl">
          Generate a personalized, professional cover letter tailored to any job description. No clichés, just real impact.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="text-xs font-bold mb-1 block">Role (optional)</label>
              <input
                value={role}
        ...
        <div className="rounded-2xl border border-border bg-card p-5 min-h-[400px]">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold">Your Cover Letter</h3>
            {result && (
              <button
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="mt-4 pt-4 border-t border-border">
                ...
                <DownloadButtons markdown={result} baseFileName="Cover-Letter" />
              </div>
            </>
          ) : (
